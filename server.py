...
def process_message():
    ...
    potomus = ["Потому что", "Покачену", "Вот так вот", "Вопросы?", "А ну в общем значит слушай значит смотри значит в общем слушай это самое мда", "Я тебе запрещаю задовать вопросы.", "ъуъ", "ъ", "🤌🏻🤌🏻", "Я в пориже хажу по магазинчикам, иду в эльфифу башню чтобы съесть qroissant", "ө"]
    potomu = randint(1,2)
